		...
		<div>
			<div class="container d-flex justify-content-center align-items-center p-5" style="height: 550px;">
				<div class="col-md-4 text-center">
					<a href="">
						<figure class="figure util-ipn">
						  <img src="./img/sell.svg" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
				...
				<div class="col-md-4 text-center">
					<a href="">
						<figure class="figure util-ipn">
						  <img src="./img/dfp.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
						  <figcaption class="figure-caption">A caption for the above image.</figcaption>
						</figure>
					</a>
				</div>
				<div class="col-md-4 text-center">
					<a href="">
						<figure class="figure util-ipn">
						  <img src="./img/report.svg" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
						  <figcaption class="figure-caption">A caption for the above image.</figcaption>
						</figure>
					</a>
				</div>
